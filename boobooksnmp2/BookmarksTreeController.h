...
@interface BookmarksTreeController : NSTreeController <NSOutlineViewDataSource>

@property IBOutlet MIBTreeTreeController * mibTreeController;
-(void)saveBookmarks;
-(void)loadBookmarks;
